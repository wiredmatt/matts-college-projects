class Sistema {
   ...
   *
   * Ejemplo: sistema.buscarAlquiler(true, 1, "wiredmatt") buscará un alquiler activo de la instancia 1, alquilada por el usuario "wiredmatt".
  ...
  precargaDeDatos() {
    ...
    let admin2 = new UsuarioAdministrador("wiredmatt", "1234La");
