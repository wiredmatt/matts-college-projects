...
dotnet ef database update --startup-project LibreriaWeb --project LogicaAccesoDatos
```

4. Start the web application

```
dotnet run --project LibreriaWeb
```
...
```sh
dotnet ef migrations add <MigrationName> --project LogicaAccesoDatos --startup-project LibreriaWeb
```
